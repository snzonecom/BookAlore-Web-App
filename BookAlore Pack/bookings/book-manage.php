...
<head>
    ...
    <title>BookAlore - Manage Bookings</title> 
</head>
<body>
    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li style="background: #f4c095;"><a href="../bookings/book-manage.php">
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
                ...
                <div class="mt-3 pt-2 mb-4">
                            <center>
                                <img src="../images/check.gif" alt="" style="width: 10%; margin: 0 auto;">
                            </center>
                </div>
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        <?php
                            ...
                            WHERE transaction_tbl.Transaction_ID = rent_status.Transaction_ID AND rent_status.Status = 'PAID'";
                            ...
                            while ($row = mysqli_fetch_assoc($showall))
                            {
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top: 1rem;">
                                        ...
                                        <a href="refund-rental.php?id=<?php echo $row['Transaction_ID'] ?>"
                                        class="link-primary" style="text-decoration: none;">
                                            <button class="btn-delete">MARK AS REFUNDED</button>
                                            
                                        </a>

                                        <a href="complete-rental.php?id=<?php echo $row['Transaction_ID'] ?>"
                                        class="link-primary" style="text-decoration: none;">
                                            <button class="btn-delete" style="background-color:#071E22; border-color:#071E22;">MARK AS COMPLETED</button>
