    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li style="background: #f4c095;"><a href="../bookings/book-record.php">
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
                ...
                <div class="mt-3 pt-2 mb-4">
                            <center>
                                <img src="../images/money.gif" alt="" style="width: 10%; margin: 0 auto;">
                            </center>
                </div>
            ...
            <div class="activity">
                <div class="title">
                    ...
                    <span class="text">BOOKING RECORDS</span>
                </div>
            </div>
        </div>
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        <?php
                            ...
                            WHERE transaction_tbl.Transaction_ID = rent_status.Transaction_ID";
                            ...
                            while ($row = mysqli_fetch_assoc($showall))
                            {
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top: 1rem;">
                                        ...
                                        <a href="delete-rental.php?id=<?php echo $row['Transaction_ID'] ?>"
