  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-4 shadow-sm sticky-top" style="font-size: large; font-weight: 500;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex">
              ...
              <a href="../home.php">
                <button type="button" class="btn btn-outline-light me-lg-2 me-2" id="logoutBtn" style="background-color: #1d7874;">Log Out</button>
            </a>
  ...
  <div class="col-lg-7 col-md-12 px-4 mt-5" style="margin: 0 auto;">
    <div class="card mb-4 border-1 shadow-sm rounded-3">
        <div class="card-body" style="text-align: center;">
            ...
            <a href="rent-form.php?user=<?php echo $user_id?>&id=<?php echo $row['House_ID']?>&rate=<?php echo $row['Price'] ?>" class="btn w-50 text-white shadow-none mt-3 mb-2" style="background:#1d7874;">Book Now</a>
