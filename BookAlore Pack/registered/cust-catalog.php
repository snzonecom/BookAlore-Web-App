  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-4 shadow-sm sticky-top" style="font-size: large; font-weight: 500;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" style="font-weight: bolder; color: #1d7874;" href="cust-catalog.php?id=<?php echo $user_id?>">HOUSE CATALOG</a>
                </li>
                <li class="nav-item">
        ...
        <div class="card mb-1 mt-2 shadow">
            <div class="row g-0 p-3 align-items-center">
                ...
                <div class="col-md-3 text-align-center">
                    ...
                    <a href="rent-form.php?user=<?php echo $user_id?>&id=<?php echo $row['House_ID']?>&rate=<?php echo $row['Price'] ?>" class="btn btn-sm w-75 btn-outline-dark shadow-none mb-2">Book Now</a>
                    <a href="cust-room.php?user=<?php echo $user_id?>&id=<?php echo $row['House_ID']?>" class="btn btn-sm w-75 btn-outline-dark shadow-none">See more details</a>
                </div>
                </div>
            </div>
