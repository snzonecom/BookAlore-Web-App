...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-4 shadow-sm sticky-top" style="font-size: large; font-weight: 500;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" style="font-weight: bolder; color: #1d7874;" href="cust-home.php?id=<?php echo $user_id?>">HOME</a>
                </li>
                <li class="nav-item">
  ...
  <div style="width: 85%;">
      <div class="row pt-5 pb-5">
        ...
        <br><br>
        <a href="cust-catalog.php?id=<?php echo $user_id?>"><button type="button" class="btn btn-outline-light mb-5" style="background-color: #1d7874;">Browse BookAlore Rental Homes Now ></button></a>
        </div>
      </div>
    </div>
  </center>
